  ...
  return (
    <View style={styles.profileInfoContainer}>
      <View style={styles.profileInfoSection}>
        ...
        <Text style={styles.infoPlaceholder}>Đang sống tại</Text>
        <Text style={styles.infoPlaceholderData}> {location}</Text>
      </View>
      <View style={styles.profileInfoSection}>
        <Feather name='clock' size={24} color='#6CA9D6' />
        <Text style={styles.infoPlaceholder}>Ngày tham gia </Text>
        <Text style={styles.infoPlaceholderData}> 8/9/2022  </Text>
      </View>
      <View style={styles.profileInfoSection}>
        <Feather name='gift' size={24} color='#6CA9D6' />
        <Text style={styles.infoPlaceholder}>Sinh nhật</Text>
