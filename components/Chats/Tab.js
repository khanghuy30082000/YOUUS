...
const InfoGroupChat = (props) => {
    ...
    //     db.collection('chatgroup').doc(chatNa),
    //     [chatNa]
    //   );
    //   if (!getChatNa) {
    //     return null;
        ...
        <SafeAreaView style={{
            ...
            <View style={styles.viewBg}>
                <Image style={styles.imgBg}
                    source={{
                        uri: 'https://images-ext-2.discordapp.net/external/6bTe5BSNP2bXA4x7UJ1sLG8ereHKvk9N_6uOZg337dk/https/64.media.tumblr.com/7d4be614323ce102131146a18a1d09c2/tumblr_pyq1oqNT4g1w89qpgo1_1280.jpg?width=882&height=662',
                    }}
                />
            </View>
